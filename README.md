...
## Використовуйте поточну стабільну версію (8.1)
...
## Інтернаціоналізація (i18n) і локалізація (l10n)
...
## Розвиток, орієнтований на поведінку
...
## Створення та розгортання вашої програми
